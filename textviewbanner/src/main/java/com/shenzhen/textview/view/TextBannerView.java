package com.shenzhen.textview.view;
...
public class TextBannerView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mFlags = typedArray.getInt(com.superluo.textbannerlibrary.R.styleable.TextBannerViewStyle_setFlags, mFlags);//字体划线
        switch (mFlags) {
            case STRIKE:
        ...
        mTypeface = typedArray.getInt(com.superluo.textbannerlibrary.R.styleable.TextBannerViewStyle_setTypeface, mTypeface);//字体样式
        switch (mTypeface) {
            case TYPE_BOLD:
