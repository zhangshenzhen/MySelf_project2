...
public class LaunchActivity extends MyBaseActivivty implements OnPermission, Animation.AnimationListener  {
    ...
    public void noPermission(List<String> denied, boolean quick) {
        if (quick) {
            ...
            XXPermissions.gotoPermissionSettings(LaunchActivity.this, true);
        }else {
            toast("请先授予文件读写权限");
    ...
    protected void onRestart() {
        super.onRestart();
        if (XXPermissions.isHasPermission(LaunchActivity.this, Permission.Group.STORAGE)) {
